      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-8 mb-16">
          ...
          <div className="text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-3 mb-3">
              ...
              <span className="font-serif text-[20px] font-bold text-white tracking-tight">
                Cactus Labs
              </span>
            </div>
          ...
          <div className="flex items-center gap-5">
            ...
            <a
              href="https://www.instagram.com/_gabrielnogueiraz/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white hover:text-landing-accent transition-colors"
            ...
            <a
              href="https://gabrielnogueiraz.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white hover:text-landing-accent transition-colors"
              aria-label="Website"
        ...
        <div className="pt-8 border-t border-[#2D2D2D] text-center md:text-left">
          <p className="font-sans text-[#858585] text-[13px]">
            © 2026 Cactus Labs — Código aberto e gratuito para todos.
          </p>
        </div>
      </div>
    </footer>
